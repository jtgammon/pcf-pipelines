...
CREATE USER IF NOT EXISTS '$DB_NFSVOLUMEDB_USERNAME'@'%' IDENTIFIED BY '$DB_ACCOUNT_PASSWORD';
GRANT ALL ON nfsvolume.* TO '$DB_NFSVOLUMEDB_USERNAME'@'%';

CREATE DATABASE IF NOT EXISTS networkpolicyserver;
CREATE USER IF NOT EXISTS '$DB_NETWORKPOLICYSERVERDB_USERNAME'@'%' IDENTIFIED BY '$DB_ACCOUNT_PASSWORD';
